...
In a high-quality supergraph, subgraphs on heterogenous sources or domains should be standardised to represent data as models and/or commands regardless of the underlying source.
